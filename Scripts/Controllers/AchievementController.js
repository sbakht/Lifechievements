var AchievementController = function($scope) {
	$scope.achievements = [{ Title : 'The Salty Splatoon', Description : 'Eat 10 tablespoons of salt', 
							Current : 6, Total : 10},
...
AchievementController.$inject = ['$scope'];